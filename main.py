...
def start_scheduler():
    ...
    # Run daily integrity check at 01:00
    schedule.every().day.at("01:00").do(job_verify_integrity)

    # Rotate keys every 30 days
    schedule.every(30).days.do(job_rotate_rsa_keys)

    # Automated backup every night at 02:00
    schedule.every().day.at("02:00").do(job_auto_backup)
